...
def finalize_legacy_json(base_filename: str, config_metadata: dict, recording_timestamp: datetime, records_queue: Queue):
    ...
    json_data = {
        ...
        "software_version": config_metadata.get("software_version", "unknown"),
        "git_commit": config_metadata.get("git_commit", "unknown"),
        "git_describe": config_metadata.get("git_describe", "unknown"),
        "exposure_times": [],
